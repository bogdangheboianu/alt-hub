...
type EventDataPayload = WorkLogRecurrence;
type EventData = { context: AuthenticatedContext; payload: EventDataPayload };

export class WorkLogRecurrenceDeactivatedEvent implements IDomainEvent<EventDataPayload> {
    readonly data: EventData;
    readonly name: string;

    constructor(data: EventData) {
        this.data = data;
        this.name = WorkLogRecurrenceDeactivatedEvent.name;
    }
