...
export abstract class BaseAsyncCommandHandler<Command> implements ICommandHandler<Command> {
...
export abstract class BaseSyncCommandHandler<Command, ReturnType> implements ICommandHandler<Command> {
