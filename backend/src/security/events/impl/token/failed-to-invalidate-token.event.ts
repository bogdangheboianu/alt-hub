...
type EventData = { context: AuthenticatedContext | PublicContext; errors: IException[] };

export class FailedToInvalidateTokenEvent implements IDomainEvent<null> {
    readonly data: EventData;
    readonly name: string;

    constructor(data: EventData) {
        this.data = data;
        this.name = FailedToInvalidateTokenEvent.name;
    }
