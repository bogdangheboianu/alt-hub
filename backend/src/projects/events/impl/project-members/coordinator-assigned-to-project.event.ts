...
type EventDataPayload = Project
type EventData = { context: AuthenticatedContext; payload: EventDataPayload };

export class CoordinatorAssignedToProjectEvent implements IDomainEvent<EventDataPayload> {
    readonly data: EventData;
    readonly name: string;

    constructor(data: EventData) {
        this.data = data;
        this.name = CoordinatorAssignedToProjectEvent.name;
    }
