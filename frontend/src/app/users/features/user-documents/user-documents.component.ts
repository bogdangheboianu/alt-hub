...
import { UserDocumentsDataService } from '@users/features/user-documents/user-documents-data.service';
...
@Component( {
                ...
                providers      : [ UserDocumentsDataService ],
                changeDetection: ChangeDetectionStrategy.OnPush
            } )
@UntilDestroy()
export class UserDocumentsComponent implements OnInit {
    constructor(
        public readonly dataService: UserDocumentsDataService,
